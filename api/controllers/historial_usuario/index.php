<?php
    include '../cors.php';
    require '../../models/historial_usuario.php';
    require '../autenticated.php';
    $datos = json_decode(file_get_contents("php://input"),TRUE);
    if(isset($_GET['historial_usuario'])) {
        ...
        $producto = new HistorialUsuario();
        $res = $producto->historialUser($data);
        unset($producto);
    ...
    if(isset($_GET['eliminar'])) {
        ...
        if(!isset($data)){
            ...
            //fin validacion token 
        $producto = new HistorialUsuario();
        $res = $producto->eliminarHistorial($data);
        unset($producto);
        echo json_encode($res);
        return 0;
    }
